import Module from './build-debug-emscripten/wasm_capillary_condensation.js';

const module = await Module()

let componentInstance = new module.Component("Custom component", 10.0, 10.0, 10.0)
...
let result = module.run_single_component_capillary_condensation(componentInstance, r_part, neck_fa, ca, surface_tension, temperature, saturation)
